...
export class Katana extends ViewModel {
  constructor(ctx) {
    super(ctx); this.name = 'KATANA'; this.hint = 'slash · hold aim to block and reflect bullets'; this.kind = 'katana';
